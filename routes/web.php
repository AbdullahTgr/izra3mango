...
Route::get('/اتفاقية_الاستخدام', [HomeController::class, 'terms'])->name('frontend.terms');
Route::get('/سياسة_الخصوصية', [HomeController::class, 'privacy'])->name('frontend.privacy');
...
Route::get('/en/{category}/{subcategory}/{subsubcategory}', [HomeController::class, 'subsubcategoryproductsbn'])->name('subsubcategoryproductsen');
