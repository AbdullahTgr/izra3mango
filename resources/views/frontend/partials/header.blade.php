            ...
            <div class="container">
              <div class="row al_center">
                ...
                <div class="col-lg-6 col-12 tc col-md-12 dn_false_1024">
                    @if (session()->get('language') === 'bangla')
                      <div class="header-text"  style="direction:rtl; text-align:right">عروض الصيف
                        <span class="cr fwm">20%</span>
                        <a href="{{ route('categoryproductsbn', $category->category_slug_bn) }}"><span class="cr fwm">تسوق الان</span> </a>
                      </div>
                  @else
                ...
                <div class="col-lg-3 col-12 tc col-md-12 tr_lg dn_false_1024">
                  <div class="nt_currency pr cg currencies sp_currencies wsn dib cur_stt_0">
                    @if (session()->get('language') === 'bangla')
                      <span class="active text-danger"  style="direction:rtl; text-align:right">اللغة</span><i
                        class="facl facl-angle-down ml__5"  style="direction:rtl; text-align:right"></i>
                    @else
                    ...
                    <ul class="pa pe_none ts__03 bgbl ul_none tl op__0 z_100 r__0 pt__15 pb__15 pr__15 pl__15">
                      ...
                      <li><a class=" cg db text-dark-blue"
                          href="{{ route('language.bangla') }}">عربي</a></li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div id="kalles-section-header_8"
                  ...
                  <form action="#"
                    ...
                    <div class="row no-gutters al_center">
                      <div class="frm_search_cat col-auto">
                        @if (session()->get('language') === 'bangla')
                        <select name="product_type"  style="direction:rtl; text-align:right">
                          <option value="*">الصنيفات</option>
          ...
          <div class="header__bot border_false dn db_lg">
                ...
                <div class="row no-gutters al_center">
                      ...
                      <ul id="nt_menu_id"
                        ...
                        <li class="type_dropdown menu-item has-children menu_has_offsets menu_right pos_right">
                            <a target="_blank" class="lh__1 flex al_center pr"
                              href="https://www.alsaeedy.com">About</a>
                          </li>
                      </ul>
                    </nav>
                  </div>
                  <div class="col-3 fs__12 ha8_txt tr">
                    ...
                    <a class="ttip_nt tooltip_top mr__10">
                      <span class="tt_txt"><Time:>{ti}</Time:></span>
                      <i class="las la-clock fs__14 mr__5"></i><span>08:00 - 10:00</span>
                    </a>
                    <a href="tel:+02%01002449142"
                      class="ttip_nt tooltip_top">
                      <span class="tt_txt">Phone: +0100 2449142</span>
                      <i class="las la-phone fs__14 mr__5"></i><span>+0100 2449142</span>
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div class="container">
                <div class="row no-gutters al_center">
                  <div class="col-auto ha8_cat">
                    <h5 class="mg__0 fs__14 flex al_center" style="direction:rtl; text-align:right">

                      <i class="las la-bars mr__5 fs__18"></i><span class="dib truncate">فئات</span>
                    </h5>
                    <div class="h_cat_nav pa op__0 mh_js_cat">
                      <ul class="lazy_menu lazy_h_cat lazyload"
                        role="menu"
                  ...
                  <div class="col ha8_nav" >
                    <nav class="nt_navigation tl hover_side_up nav_arrow_false" style="direction:rtl; text-align:right">
                      <ul id="nt_menu_id"
                        class="nt_menu in_flex wrap al_center">
                        <li class="type_dropdown menu-item has-children menu_has_offsets menu_right pos_right">
                          <a class="lh__1 flex al_center pr"
                            href="{{ route('frontend.home') }}">الرئيسية</a>
                        </li>
                        <li class="type_dropdown menu-item has-children menu_has_offsets menu_right pos_right">
                            <a target="_blank" class="lh__1 flex al_center pr"
                              href="https://www.alsaeedy.com">عنا</a>
                          </li>
                      </ul>
                    </nav>
                  </div>
                  <div class="col-3 fs__12 ha8_txt tr">
                    <a href=""
                      ...
                      <span class="tt_txt"><span class="__cf_email__"
                          data-cfemail="a6cdc7cacac3d5e6c2c9cbc7cfc888c5c9cb">Ecommerce</span></span>
                      <i class="las la-envelope fs__14 mr__5"></i><span>تسوق</span>
                    </a>
                    <a class="ttip_nt tooltip_top mr__10">
                      <span class="tt_txt"></span>
                      <i class="las la-clock fs__14 mr__5"></i><span></span>
                    </a>
                    <a href="tel:+01%2023456789"
                      class="ttip_nt tooltip_top">
                      <span class="tt_txt">Phone: +01002449142</span>
                      <i class="las la-phone fs__14 mr__5"></i><span>+01002449142</span>
                    </a>
                  </div>
                </div>
              </div>
