<div id="nt_menu_canvas"
  ...
  <div class="mb_nav_tabs flex al_center mb_cat_true">
    <div class="mb_nav_title pr mb_nav_ul flex al_center fl_center active"
      ...
      <span class="db truncate"> {{ session()->get('language') === 'bangla' ? 'القائمة' : 'Menu' }}</span>
    </div>
    <div class="mb_nav_title pr mb_nav_ul flex al_center fl_center "
      data-id="#kalles-section-mb_nav_js2">
      <span class="db truncate">{{ session()->get('language') === 'bangla' ? 'فئات' : 'Categories' }}</span>
    </div>
    ...
    <div id="kalles-section-mb_nav"
      ...
      <ul id="menu_mb_ul"
        ...
        <li class=" menu-item menu-item-btns menu-item-home">
          <a
            href="{{ route('frontend.home') }}"><span>{{ session()->get('language') === 'bangla' ? 'الرئيسية' : 'Home' }}</span></a>
        </li>
        <li class="menu-item menu-item-btns menu-item-home">
          <a target="_blank"
            href="https://alsaeedy.com"><span>{{ session()->get('language') === 'bangla' ? 'عنا' : 'About' }}</span></a>
        </li>
        <li class="menu-item menu-item-btns menu-item-home">
          <a target="_blank"
            href="https://alsaeedy.com"><span>Contact</span></a>
        </li>

        <li class="menu-item menu-item-infos">
          <p class="menu_infos_title">Need help?</p>
          <div class="menu_infos_text">
            <i class="pegk pe-7s-call fwb mr__10"></i>+01002449142<br><i
              class="pegk pe-7s-mail fwb mr__10"></i>4multijob@gmail.com
          </div>
        </li>
      ...
      @if (session()->get('language') === 'bangla')
        <ul id="menu_mb_ul"
          ...
          <li class="menu-item menu-item-infos">
            <p class="menu_infos_title">Need help?</p>
            <div class="menu_infos_text">
              <i class="pegk pe-7s-call fwb mr__10"></i>+02 01002449142<br>
