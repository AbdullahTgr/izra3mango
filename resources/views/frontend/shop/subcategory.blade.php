...
<meta name="description" content="{{$subcategory->extra }} - {{$subcategory->whatsapp_num }}">
<meta property="og:title" content="{{$subcategory->subcategory_name_en }}">
<meta property="og:description" content="{{$subcategory->extra }} - {{$subcategory->whatsapp_num }}">
...
<meta name="description" content="{{$subcategory->extra }} - {{$subcategory->whatsapp_num }}">
<meta property="og:title" content="{{$subcategory->subcategory_name_bn }}">
<meta property="og:description" content="{{$subcategory->extra }} - {{$subcategory->whatsapp_num }}">
    ...
    @else
      ...
      <div class="container container_cat nt_pop_sidebar cat_default mb__20">
        ...
        <h2 class="product_title entry-title fs__16" style="color: #e91e63;">
          ...
          @endif
                    ...
                    @if (session()->get('language') === 'bangla')
                      ...
                      <a href="https://api.whatsapp.com/send?phone=+02{{ $subcategory->whatsapp_num }}&text=ممكن تفاصيل اكتر؟" target="_blank"
                              data-time="6000"
                              data-ani="shake"
        ...
        color: #4caf50;
                      ...
                      href="https://api.whatsapp.com/send?phone=+02{{ $subcategory->whatsapp_num }}&text=ممكن تفاصيل اكتر؟" target="_blank" >
                  ...
                  <a href="https://api.whatsapp.com/send?phone=+02{{ $subcategory->whatsapp_num }}&text=Can u give me more details ?" target="_blank"
                    data-time="6000"
                    data-ani="shake"
                    class=" button  animated "
                  >
        ...
        color: #4caf50;
            ...
            href="https://api.whatsapp.com/send?phone=+02{{ $subcategory->whatsapp_num }}&text=Can u give me more details ?" target="_blank" >
