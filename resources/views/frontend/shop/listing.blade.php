          ...
          <div class="product-image pr oh lazyload">
            ...
            <div class="hover_button op__0 tc pa flex column ts__03">
              ...
              <a class="pr pr_atc cd br__40 bgw tc dib js__qs cb chp ttip_nt tooltip_top_left  productView"
                href="#"
                product_id={{ $product->id }}><span class="tt_txt">اضف الي العربة</span><i
                  class="iccl iccl-cart"></i><span>اضف الي العربة</span></a>
            </div>
          </div>
          ...
          <div class="product-info mt__15"> 
            ...
            @if (isset($product->discount))
              <p class="price_range"
                ...
                <ins>
                  L.E {{ round($product->price - ($product->discount * $product->price) / 100) }}</ins>
              </p>
            @else
