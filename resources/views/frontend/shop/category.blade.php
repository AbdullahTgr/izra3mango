      ...
      <div class="container">
        <div class="row al_center">
          <div class="col">
            ...
            @else
              <nav class="sp-breadcrumb">
                <a href="{{ route('frontend.home') }}">الرئيسية</a><i
        ...
        <div class="row">
          <div class="col-lg-12 col-12">
            <div class="kalles-section tp_se_cdt">
              ...
              <div class="on_list_view_false products nt_products_holder row fl_center row_pr_1 cdt_des_1 round_cd_false nt_cover ratio_nt position_8 space_30 nt_default filterOption">
