...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  })(window,document,'script','dataLayer','GTM-MJN4L73');</script>
  ...
  <style>
    body,a,span,p,h1,h2,h3,h4,h5,h6{
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-834828VWJJ"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-834828VWJJ');
</script>
<body
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MJN4L73"
    ...
    function CouponCalculate() {
      $.ajax({
        ...
        @if (session()->get('language') === 'bangla')
          ...
          $('#couponData').html(`
          <div class="total row in_flex fl_between al_center cd fs__18 tu">
            <div class="col-auto"><strong class="text-primary">الاجمالي الفرعي:</strong></div>
            <div class="col-auto tr js_cat_ttprice fs__20 fwm">
          ...
          <span class="db txt_tax_ship mb__5 mt_5"><b><code>${data.coupon_name}</code> counpon(${data.coupon_discount} %) : -
            ...
            <a href="#"
              ...
              id=""
              class="ttip_nt tooltip_top_right "><span class="tt_txt">احذف الكوبون</span>
              <svg style="width: 20px;height: 20px;stroke-width: 1.5;"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                stroke="currentColor"
          ...
          <div class="total row in_flex fl_between al_center cd fs__18 tu">
            <div class="col-auto"><strong class="text-danger">الاجمالي:</strong></div>
            <div class="col-auto tr js_cat_ttprice fs__20 fwm">
