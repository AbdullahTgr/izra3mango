        ...
        @if (Cart::content()->count() > 0)
          <div class="cart_header cartCheckout">
            <div class="row al_center mb_5">
              <div class="col-5">منتج</div>
              <div class="col-3 tc">سعر</div>
              <div class="col-2 tc">كمية </div>
              <div class="col-2 tc tr_md">المجموع</div>
            </div>
          </div>
        @endif
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 cart_actions tl_md tc order-md-2 order-2 mb__50">
                  <div class="widget widget_text">
                    <h3 class="widget-title fwsb flex al_center fl_between fs__16 mg__0 mb__30">
                      <span class="txt_title">قسيمة</span>
              ...
              @else
                ...
                <div class="col-12 col-md-6 cart_actions tl_md tc order-md-2 order-2 mb__50"
                  ...
                  <div class="widget widget_text">
                    ...
                    <div class="widget_footer newl_des_1">
                      <p>تطبيق قسيمة إذا كان لديك للحصول على الخصم</p>
                      <form id="contact_form"
                        class="mc4wp-form pr z_100">
                        <div class="mc4wp-form-fields">
              ...
              <div class="col-12 tr_md tc order-md-4 order-4 col-md-6">
                ...
                <a href="{{ route('frontend.commingSoon') }}"
                  ...
                  name="checkout"
                  class="btn_checkout button button_primary tu mt__10 mb__10 js_add_ld">الدفع</a>
