...
<meta name="description" content="Plant a mango Mango tree growth stages with pictures">
<meta property="og:title" content="Plant a mango">
<meta property="og:description" content="Mango tree growth stages with pictures">
...
<meta property="og:description" content="مراحل نمو شجرة المانجو بالصور | مراحل نمو النبات">
...
<div id="nt_wrapper">
              ...
              <div class="caption-wrap caption-w-1 pe_none z_100 tl_md tl">
                ...
                <div class="pa_txts caption">
                  <div class="right_left">
                    ...
                    <a class="kalles-kids__slide-layout-01__button slt4_btn button pe_auto round_true btn_icon_false" href="{{ route('categoryproductsbn', $category->category_slug_bn) }}">اكتشف الان</a>
                  </div>
                </div>
                @else
                <div class="pa_txts caption">
              ...
              <div class="caption-wrap caption-w-1 pe_none z_100 tl_md tl">
                <div class="pa_txts caption">
                  <div class="right_left">
                    ...
                    <div class="kalles-kids__slide-layout-01__br-03 slt4_space"></div>
                    <a class="kalles-kids__slide-layout-01__button slt4_btn button pe_auto round_true btn_icon_false" href="/">Explore Now</a>
                  </div>
                </div>
              </div>
              <a href="/" class="pa t__0 l__0 b__0 r__0 pe_none"></a>
        ...
        <div class="medizin_laypout">
          <div class="product-cd-header in_flex wrap al_center fl_center tc">
            <h6 class="product-cd-heading section-title">
              {{ session()->get('language') === 'bangla' ? 'عروض اليوم' : 'Daily Deal Of The Day' }}
            </h6>
            <div class="countdown-wrap in_flex fl_center al_center wrap pr_deal_dt">
              <div class="countdown-label">
                {{ session()->get('language') === 'bangla' ? 'ينتهى في' : 'End in' }}:</div>
            ...
            <div class="col-lg-15 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__2 tc">
              <div class="product-inner pr">
                <div class="product-image pr oh lazyload">
                  ...
                  @if ($product->category->icon!="coworking")
                ...
                <div class="product-info mt__15">
                  ...
                  @else
                  <span class="price dib mb__5"> L.E  {{ $product->price }} <span class="text-danger"></span></span>
                  @endif
                </div>
              </div>
            </div>
        ...
        <div class="tab_se_wrap">
          <div class="tab_se_header tc mt__30">
            <ul class="tab_cat_title ul_none des_tab_10">
              ...
              <li class="dib">
                <a class="js_t4_tab tt_active" data-bid="all" href="#"><span>{{ session()->get('language') === 'bangla' ? 'الكل' : 'All' }}</span></a>
              </li>
 ...
 <div class="hover_button op__0 tc pa flex column ts__03">
                        ...
                        <a href="#" class="pr pr_atc cd br__40 bgw tc dib js__qs cb chp ttip_nt tooltip_top_left  productView" product_id={{ $product->id }}><span class="tt_txt">اضف الي العربة</span><i class="iccl iccl-cart"></i><span>اضف الي العربة</span></a>
                      </div>
                      @endif
                    </div>
                    <div class="product-info mt__15">
    ...
    <div class="kalles-section nt_section type_featured_collection tp_se_cdt">
      <div class="kalles-electronic-vertical__bestseller container">
        <div class="row al_center fl_center title_10">
          <div class="col-auto col-md">
            <h3 class="dib tc section-title fs__24">{{ session()->get('language') === 'bangla' ? 'الاكثر رواجا' : 'Hot Deals' }}</h3>
          ...
          <div class="col-lg-2 col-md-3 col-6 pr_animated done mt__30 pr_grid_item product nt_pr desgin__2 tc">
            <div class="product-inner pr">
              <div class="product-image pr oh lazyload">
                ...
                @if ($product->category->icon!="coworking") {{ $product->category->icon }} {{ $product->category->icon }}
        ...
        <div class="products-footer tc mt__40">
            @if (session()->get('language') === 'bangla')
          <a class="se_cat_lm pr  button button_dark br_rd_false btn_icon_false" href="{{ route('categoryproductsbn', $category->category_slug_bn) }}">اكثر</a>
            @else
