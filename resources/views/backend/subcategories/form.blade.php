      ...
      <div class="card radius-15 border-lg-top-info">
        ...
        <div class="card-body">
          <div class="form-body">
            ...
            <input type="text" class="form-control  @error('whatsapp_num') is-invalid @enderror" name="whatsapp_num" value="{{ $subcategory->whatsapp_num ?? old('whatsapp_num') }}" placeholder="رقم الواتس اب" required>
            @error('whatsapp_num')
            ...
            <label class="col-form-label"> <span class="text-danger">*</span></label>
            <input type="text" class="form-control  @error('extra') is-invalid @enderror" name="extra" value="{{ $subcategory->extra ?? old('extra') }}" placeholder="عنوان المكان" required>
            @error('extra')
            <span class="text-danger" product="alert">
              <strong>{{ $message }}</strong>
            </span>
